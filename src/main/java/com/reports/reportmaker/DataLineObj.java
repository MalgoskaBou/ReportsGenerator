...
/**
 * Object generated by {@link ReadFileCSV} and {@link ReadFileXML} classes
 * Contains information from a read line in CSV, or node in XML.
 * Used to unify the output information from read files and for further validation and error identification.
 */
...
class DataLineObj {
     ...
     * @return returns the object of {@link DataModel} if the input data is correct, or null if any exception is detected
     */
